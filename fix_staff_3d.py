...
staff_tsx = """import React, { useState } from 'react';
  ...
  return (
    <div className="space-y-6">
      <div className="card-3d p-6 bg-gradient-to-br from-slate-900 to-indigo-950/50">
        <h2 className="text-2xl font-bold text-white mb-2">Staff Transit Portal</h2>
...
"""
with open("src/components/staff/StaffDashboard.tsx", "w") as f:
    f.write(staff_tsx)
print("StaffDashboard updated")
